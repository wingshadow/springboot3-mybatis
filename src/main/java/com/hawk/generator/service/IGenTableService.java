...
public interface IGenTableService {
     ...
     * @return 业务集合
     */
    PageInfo<GenTable> selectPageGenTableList(GenTable genTable, PageQuery pageQuery);
     ...
     * @return 数据库表集合
     */
    PageInfo<GenTable> selectPageDbTableList(GenTable genTable, PageQuery pageQuery);
